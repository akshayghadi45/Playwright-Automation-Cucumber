...
public class BasePage {
    ...
    //protected = can be accessed by classes in the same package or by the subclass
    protected BrowserManager getBrowserManager() {
        return browserManager;
    }

    public void waitAndClickByRole(String role, String name) {
        Locator locator = browserManager.getPage().getByRole(AriaRole.valueOf(role.toUpperCase()), new Page.GetByRoleOptions().setName(name) );
        locator.click();
    }
